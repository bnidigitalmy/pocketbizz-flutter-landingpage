-- ============================================================================
-- ENHANCE UNIT CONVERSION FUNCTION
-- Expands unit conversion untuk match Flutter implementation
-- ============================================================================

-- Drop existing function
DROP FUNCTION IF EXISTS convert_unit(NUMERIC, TEXT, TEXT);

-- Create enhanced unit conversion function
...
BEGIN
    ...
    IF v_from = 'dozen' THEN
        IF v_to = 'pcs' OR v_to = 'pieces' OR v_to = 'unit' OR v_to = 'units' THEN
    ...
    -- This allows system to continue but may cause calculation issues
...
COMMENT ON FUNCTION convert_unit IS 'Enhanced unit conversion function dengan support untuk 20+ units (weight, volume, count)';
