-- Purchase Orders System Migration (SAFE VERSION)
...
CREATE INDEX idx_purchase_orders_owner ON purchase_orders(business_owner_id);
CREATE INDEX idx_purchase_orders_status ON purchase_orders(business_owner_id, status);
...
CREATE INDEX idx_po_items_owner ON purchase_order_items(business_owner_id);
...
BEGIN
    ...
    -- Create expense record (only if expenses table exists)
